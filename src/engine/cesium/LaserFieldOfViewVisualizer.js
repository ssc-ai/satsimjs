...
class LaserFieldOfViewVisualizer extends CompountElementVisualizer {
  constructor(viewer, site, gimbal, laser, universe, color, inactiveColor) {
    ...
    const e = viewer.entities.add({
      ...
      ellipsoid: {
        radii: new CallbackProperty((time, result) => {
          ...
          let range = gimbal.range <= 0 ? 1.0 : gimbal.range
        ...
        minimumClock: new CallbackProperty(() => CMath.toRadians(-laser.x_fov / 2), false),
        maximumClock: new CallbackProperty(() => CMath.toRadians(laser.x_fov / 2), false),
        minimumCone: new CallbackProperty(() => CMath.toRadians(90 - laser.y_fov / 2), false),
        maximumCone: new CallbackProperty(() => CMath.toRadians(90 + laser.y_fov / 2), false),
...
export default LaserFieldOfViewVisualizer
